...
def calculate(x, y): return x * y  # odiiy structurasi


result = calculate(3, 5)
print("result:", result)

# list sorted bn lambda function
...
people.sort()  # sorted by alphabit
